...
import { getAllPlayers, getCurrentPlayer, getPlayer, loginPlayer, logoutPlayer, registerPlayer, updatePlayerDetails } from "../controllers/player.controller.js";
...
router.route("/login-player").post(loginPlayer)
